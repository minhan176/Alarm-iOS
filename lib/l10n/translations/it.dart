const Map<String, String> itTranslations = {
  ...
  'overlayDialogContent': 'Seleziona "Apri impostazioni" → Clock OS 26 → Consenti visualizzazione sopra altre app',
  ...
  'guideStep1Sub1': 'Vai su Impostazioni → App → Clock OS 26',
  ...
  'guideStep2Sub1': 'Vai su Impostazioni → App → Clock OS 26',
