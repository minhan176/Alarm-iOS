const Map<String, String> heTranslations = {
  ...
  'overlayDialogContent': 'בחרו "פתח הגדרות" → Clock OS 26 → אפשר תצוגה מעל אפליקציות אחרות',
  ...
  'guideStep1Sub1': 'עברו להגדרות → אפליקציות → Clock OS 26',
  ...
  'guideStep2Sub1': 'עברו להגדרות → אפליקציות → Clock OS 26',
