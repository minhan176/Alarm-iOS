const Map<String, String> esTranslations = {
  ...
  'am': 'AM',
  'pm': 'PM',
  'ratingTitle': '¿Disfrutas de Clock OS 26?',
  ...
  'overlayDialogContent': 'Selecciona "Abrir configuración" → Clock OS 26 → Permitir mostrar sobre otras apps',
  ...
  'guideStep1Sub1': 'Ve a Configuración → Apps → Clock OS 26',
  ...
  'guideStep2Sub1': 'Ve a Configuración → Apps → Clock OS 26',
