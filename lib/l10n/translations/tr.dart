const Map<String, String> trTranslations = {
  ...
  'am': 'ÖÖ',
  'pm': 'ÖS',
  'ratingTitle': 'Clock OS 26\'dan memnun musunuz?',
  ...
  'overlayDialogContent': '"Ayarları Aç" → Clock OS 26 → Diğer uygulamaların üzerinde göstermeye izin ver seçeneğini seçin',
  ...
  'guideStep1Sub1': 'Ayarlar → Uygulamalar → Clock OS 26 yolunu izleyin',
  ...
  'guideStep2Sub1': 'Ayarlar → Uygulamalar → Clock OS 26 yolunu izleyin',
